...
import { Calendar, Users, Scissors, UserCheck, BarChart2, Bot, Zap, Gift, CreditCard, Settings, LogOut, LayoutDashboard, Building2, Crown } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/queue', icon: Users, label: 'Fila Virtual' },
